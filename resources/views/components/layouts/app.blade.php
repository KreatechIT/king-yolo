...
<head>
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-WG3G10FFQL"></script>
    <script>
    ...
    <script src="{{ asset('assets/js/review-carousel.js') }}"></script>
