    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden md:block">
                <a href="contact.html" class="px-6 py-2 rounded-full border glass-effect">Contact Us</a>
            </div>
...
<div id="mobile-nav"
    ...
    <div class="px-6 py-4 space-y-4">
        <a href="index.html" class="block py-2 text-text-light hover:text-primary-gold transition-colors">Home</a>
        ...
        <a href="about.html" class="block py-2 text-text-light hover:text-primary-gold transition-colors">About</a>
        <a href="contact.html" class="block py-2 rounded-lg mt-4">Contact Us</a>
    </div>
</div>