<section>
    ...
    <div class="py-20 relative" data-aos="fade-up">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="text-center mb-16" data-aos="fade-up">
                ...
                <h2 class="font-inter text-4xl lg:text-5xl font-bold text-white mb-6">
                    <span class="text-primary-gold">Product </span> Success
                    Stories
                </h2>
                <p class="text-lg text-gray-300 max-w-2xl mx-auto">
                    See how financial institutions are transforming their operations
                    with Kingtech
                </p>
            </div>

            <div class="relative overflow-hidden">
                <div id="kingtech-carousel" class="flex transition-transform duration-700 ease-in-out"
    ...
    <div class="py-20 relative">
        <div class="max-w-5xl mx-auto px-6 lg:px-8">
            <div class="text-center mb-16" data-aos="fade-up">
                ...
                <h2 class="font-inter text-4xl lg:text-5xl font-bold text-white mb-6">
                    KingTech <span class="text-primary-gold">FAQ</span>
                </h2>
                <p class="text-lg text-gray-300">
                    Everything you need to know about KingTech banking automation
                </p>
            </div>
    ...
    <!-- KingTech CTA Section -->
    <div class="py-20 relative" data-aos="fade-up">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="gradient-bg rounded-3xl p-12 lg:p-16 text-center relative overflow-hidden">
                <div class="relative z-10">
                    ...
                    <h2 class="font-inter text-4xl lg:text-6xl font-bold text-white mb-6">
                        ...
                        <span class="text-primary-gold">Today</span>
                    </h2>
                    <p class="text-xl text-white/90 max-w-3xl mx-auto mb-10">
                        Join thousands of financial institutions already using KingTech to
